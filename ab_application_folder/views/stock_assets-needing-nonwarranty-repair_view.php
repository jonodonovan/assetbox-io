...
<?php echo form_hidden('formtype', 'repairout'); ?><br><br>
<?php echo form_submit(array('name' => 'update', 'class' => 'btn btn-primary general_button', 'value' => 'update checked to status "repair out"')); ?>
<?php echo form_close(); ?>
<?php } ?>
